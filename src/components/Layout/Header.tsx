...
import { Search, Bell, Moon, Sun, User, RefreshCw, CheckCircle, AlertCircle, LogOut } from 'lucide-react';
...
export default function Header({ darkMode, onToggleDark, sidebarWidth }: HeaderProps) {
  ...
  return (
    <header
      className="fixed top-0 right-0 z-30 h-16 flex items-center justify-between px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-300"
      ...
      <div className="flex items-center gap-2 ml-4">
        ...
        <div className="flex items-center gap-2 ml-1 pl-2 border-l border-gray-200 dark:border-gray-700">
          ...
          <button onClick={logout} title="Sign out"
            className="p-1.5 ml-1 rounded-lg text-gray-400 hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/20 transition-colors">
